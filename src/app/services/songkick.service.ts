...
export class SongkickService {
  ...
  private apiUrlLocationSearch1 = 'https://api.songkick.com/api/3.0/metro_areas/';
  ...
  searchVenueDetails(venueResult) {
    return this.http.get(this.apiUrlVenueDetails1 + venueResult + this.apiUrlVenueDetails2);
  }
}
